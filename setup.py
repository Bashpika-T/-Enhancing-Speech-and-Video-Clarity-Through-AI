...
def write_version(version_core, pre_release=True):
    ...
    with open(Path("resehancing_the_audio_and_Video", "version.py"), "w") as f:
        f.write('__version__ = "{}"\n'.format(version))
...
setup(
    name="Enhancing_the_audio_and_Video",
    ...
    entry_points={
        "console_scripts": [
            "Ehancing_the_audio_and_Video= resemble_enhance.enhancer.__main__:main",
        ]
    },
)
